...
my_chart$chart_param_diff_absolute
my_chart$chart_param_diff_percent
...
my_chart <- rchart::chart(data)
my_chart$chart_class
```

## Multi Param Multi Class
...
## Multi Param Multi Class Multi Region
```{r, results = 'hide', eval=TRUE, echo=TRUE, warning=FALSE, error = FALSE, message = FALSE, fig.width=21, fig.height = 10}
library(rchart);
